...
class _ExecutionReportsPageState extends State<ExecutionReportsPage> {
  ...
  Future<void> _fetchReports() async {
    ...
    try {
      ...
      print('📋 [ExecReports] Calling ReportingService.GetExecutionReports via native gRPC');
      ...
      print('📋 [ExecReports] Got ${reports.length} reports, totalCount=$totalCount');
      if (reports.isNotEmpty) {
        print('📋 [ExecReports] First report: execId=${reports.first.execId}, symbol=${reports.first.symbol}, side=${reports.first.side}');
      }
    ...
    return DataTable(
      ...
      rows: _reports.map((report) {
        ...
        return DataRow(cells: [
          ...
          _copyableCell(_str(report, 'price'), isDarkTheme),
          _copyableCell(_str(report, 'orderQty', 'order_qty'), isDarkTheme),
          _copyableCell(_str(report, 'cumQty', 'cum_qty'), isDarkTheme),
          _copyableCell(_str(report, 'leavesQty', 'leaves_qty'), isDarkTheme),
          _copyableCell(_str(report, 'avgPx', 'avg_px'), isDarkTheme),
          ...
          _copyableCell(_str(report, 'transactTime', 'transact_time'), isDarkTheme),
          _copyableCell(_str(report, 'createdAt', 'created_at'), isDarkTheme),
  ...
  DataCell _copyableCell(String value, bool isDarkTheme, {double maxWidth = _defaultMaxCellWidth}) {
    final display = _truncate(value);
