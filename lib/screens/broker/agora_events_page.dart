  ...
  Widget _buildEventsTable(bool isDarkTheme) {
    return StyledDataTable(
      ...
      columns: const [
        ...
        StyledColumn(label: 'Event Hash', flex: 2),
        StyledColumn(label: 'Event Type', flex: 2),
        ...
        StyledColumn(label: 'Qty', flex: 1),
        StyledColumn(label: 'Err', flex: 1),
        StyledColumn(label: 'Reason', flex: 1),
        StyledColumn(label: 'Quote Bal', flex: 1),
        StyledColumn(label: 'Engine Addr', flex: 2),
        StyledColumn(label: 'Deploy IID', flex: 2),
