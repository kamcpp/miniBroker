...
class ConfigValidator {
  ...
  static const String configFileName = 'miniBroker-config.json';
  ...
  static String getAppDirectory() {
    ...
    // On macOS, the executable is inside "miniBroker.app/Contents/MacOS/miniBroker"
    ...
    if (Platform.isMacOS && appDir.contains('.app/Contents/MacOS')) {
      // Navigate up from: /path/to/miniBroker.app/Contents/MacOS
      ...
      appDir = path.dirname(appDir);          // miniBroker.app directory
    ...
    try {
      ...
      if (!configFileExists()) {
        ...
        return ConfigValidationResult(
          isValid: false,
          errorMessage: '$configFileName does not exist at the miniBroker app directory.\n\nExpected location: $configPath',
