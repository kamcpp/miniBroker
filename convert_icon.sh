...
# Script to convert the FIXYL Quick logo to macOS app icon sizes
# Usage: Place your logo as 'logo.png' in the same directory as this script, then run it

# Check if logo.png exists
if [ ! -f "logo.png" ]; then
    echo "Error: logo.png not found. Please place your FIXYL Quick logo as 'logo.png' in this directory."
    exit 1
fi
